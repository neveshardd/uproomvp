...
-- 23. Create function to create direct conversation
...
BEGIN
    ...
    WHERE c.type = 'direct' 
    AND c.company_id = create_direct_conversation.company_id
    ...
    VALUES (create_direct_conversation.company_id, 'direct', participant1_id)
